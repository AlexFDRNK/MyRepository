...
//1. Ознакомьтесь с предоставлеными материалами.
//2. Обязательно удалите мертвый код
//3. Не забывайте использовать константные ссылки итерировании по коллекции
//4. Всегда обращайте внимание на такие ошибки в рассчетах, как деление на ноль

//Все написано хорошо. Есть вещи которые нужно поправить. Пока не сдали. Ознакомьтесь с материалами
//и исправьте ошибки и все получиться.
